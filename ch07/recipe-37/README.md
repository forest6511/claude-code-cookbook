# Recipe 37: Adding Dynamic Parameters with $ARGUMENTS

Your Skills have static instructions. You can't change behavior based on arguments or inject runtime data like command output.
